...
public class BinomialMinPQ<Key> implements Iterable<Key> {
    protected Node head;    				//head of the list of roots
    private final Comparator<Key> comp;	//Comparator over the keys

    //Represents a Node of a Binomial Tree
    public class Node {
        public Key key;						//Key contained by the Node
        public int order;						//The order of the Binomial Tree rooted by this Node
        public Node child;
        public Node sibling;			//child and sibling of this Node
    }
